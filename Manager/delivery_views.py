    ...
    try:
        with transaction.atomic():
            order_his = OrderHistory.objects.create(
                order=order,
                user=order.user,
                rcv_address_name =order.rcv_address_name,
                rcv_address_type =order.rcv_address_type,
                rcv_name =order.rcv_name,
                rcv_contact_no =order.rcv_contact_no, 
                rcv_house_no =order.rcv_house_no,
                rcv_street =order.rcv_street,
                rcv_locality =order.rcv_locality,
                rcv_city =order.rcv_city,
                rcv_district =order.rcv_district,
                rcv_state =order.rcv_state,
                rcv_pincode =order.rcv_pincode,
